...
import { FaBuilding, FaMapMarkerAlt, FaRegCalendarAlt } from 'react-icons/fa'; // react-icons kullanıyoruz
...
const Timeline = () => {
    // Kart hover efektlerini geliştirelim
    const cardVariants = {
        hover: {
            scale: 1.02,
        ...
        <section id="experience" className="py-20 bg-white dark:bg-black">
            ...
            >
                ...
                <div className="relative">
                    {/* Timeline çizgisi - Gradient kaldırıldı, düz renkler eklendi */}
                    ...
                    {timelineData.map((item, index) => (
                        ...
                        >
                            {/* Timeline nokta ve animasyon halkası */}
                            ...
                            {/* İçerik kartı - Tek bir div içinde conditional rendering yapalım */}
                            {index % 2 === 0 ? (
                                <>
                                    <div className="w-full md:w-5/12 md:pr-12">
                                        <TimelineCard item={item} cardVariants={cardVariants} />
                                    </div>
...
// TimelineCard bileşenini ayrı bir component olarak çıkaralım
const TimelineCard = ({ item, cardVariants }: { item: TimelineItem, cardVariants: any }) => (
    <motion.div
