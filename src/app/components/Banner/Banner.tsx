...
const Banner = () => {
    ...
    return (
        <section id="about" className="min-h-screen flex items-center relative bg-white dark:bg-black py-20 overflow-hidden">
            <div className="fixed right-[-50%] top-[0%] w-[100%] h-[100%] rounded-full bg-[radial-gradient(circle_at_center,rgba(147,51,234,0.3),transparent_70%)] dark:bg-[radial-gradient(circle_at_center,rgba(249,115,22,0.3),transparent_70%)] hidden md:block pointer-events-none" />
